...
public:
	...
	inline string getStringVal() const { assert( mType == STRING_VAL ); return string(mData.stringVal); };
...
public:
	...
	void replaceEntries(const string& fileName, DataRepository* pRepository);
	void outputToFile(const string& fileInName, DataRepository* pRepository, const string& fileOutName = "");
